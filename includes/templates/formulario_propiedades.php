<fieldset>
    ...
    <label for="titulo">Titulo:</label>  <!-- le agregamos el 'propiedad[]' en la parte de name para que se agrupen en un arreglo con la key de 'propiedad' -->
    <input type="text" id="titulo" name="propiedad[titulo]" placeholder="Titulo Propiedad" value="<?php echo s($propiedad->titulo); ?>">  <!--es para llenar los campos con un valor que ya le habiamos pasado previamente-->
